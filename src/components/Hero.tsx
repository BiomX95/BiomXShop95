...
export default function Hero() {
  ...
  return (
    <section className="bg-gradient-to-r from-primary to-[hsl(var(--primary)/0.8)] text-white">
      <div className="container mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center">
        <div 
          ...
          className={cn(
            ...
            textAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          )}
        >
        ...
        <div 
          ...
          className={cn(
            ...
            imageAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          )}
        >
